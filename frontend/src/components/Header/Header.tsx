      ...
      <nav className='nav-bar bg-white dark:bg-[#33353a] dark:border-[#42464D] sm:flex-wrap sm:h-[110px]'>
        ...
        <div className='nav-center sm:pr-0 sm:pb-4 sm:justify-center '>
          <div className='nav-list'>
            ...
            <Link href='/exchange/sell' as='/exchange/sell' className={`drop-in-underline duration-300 dark:text-[#B9BBBE] dark:hover:text-[#a36bfc] relative group/item ${pathName.includes('/sell') ? 'text-[#8045dd] dark:text-[#a36bfc] drop-in-underline-active' : 'text-[#7d8395]'}`}>
              아이템 거래
              <div className='absolute top-[45px] flex items-center flex-col invisible group-hover/item:visible shadow-[0px_1px_4px_0px_rgba(0,0,0,0.25)] w-[110px] text-black dark:text-white rounded-b-md rounded-r-md'>
